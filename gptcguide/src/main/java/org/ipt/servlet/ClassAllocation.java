    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            try {
                ...
                PreparedStatement pst = con.prepareStatement("INSERT INTO DB_GPTC.ClassTbl (Dep_Id,Tutor_Id,Semester) VALUES (?,?,?)");
                ...
                try {
                    ...
                    Logger.getLogger(ClassAllocation.class.getName()).log(Level.SEVERE, null, ex);
                    request.getRequestDispatcher("/class_table.jsp").forward(request, response);
                }
            }
        }
