      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            ...
            <ul class="treeview-menu">
              ...
              <li><a href="subjectadd.jsp"><i class="fa fa-circle-o"></i>Subject Add</a></li>
              <li><a href="subjectallot.jsp"><i class="fa fa-circle-o"></i>Subject Allot</a></li>
            </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="treeview" >
          <a href="#">
            ...
            <ul class="treeview-menu">
                <li id="menutopic"><a href="Timetable.jsp"><i class="fa fa-circle-o"></i> TimeTable</a></li>
            </ul>
        </li>
        <li class="treeview" id="treeassignment">
          <a href="#">
            <i class="fa fa-edit"></i> <span>Assignment</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
              <li id="menutopic"><a href="index.jsp"><i class="fa fa-circle-o"></i> Topics Submission</a></li>
